<h1 align="center">Хей 👋, меня зовут Илья</h1>
<h3 align="center">И я пишу на django</h3>

- 🔭 Сейчас я работаю над [DRF_LMS](https://github.com/Lio-Kay/DRF_LMS)

- 🌱 На данный момент я углубляю свои знания о **DRF, паттернах, и ООП**
